  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="px-6 space-y-5">
        ...
        <Button onClick={() => setToast('Password changed.')} disabled={!current || !newPass || newPass !== confirm} className="w-full bg-[#111111] text-white hover:bg-[#333] rounded-full h-12 text-sm font-medium disabled:opacity-40">Save</Button>
      </div>
