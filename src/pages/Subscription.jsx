          ...
          {isTrial && (
            <div className="space-y-2 text-xs text-gray-500">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-[#111111]">{format(trialStart, 'MMM d, yyyy')}</span>
              </div>
              <div className="flex justify-between">
                <span>Expires on</span>
                <span className="font-medium text-[#111111]">{format(trialEnd, 'MMM d, yyyy')}</span>
              </div>
            </div>
          )}
          ...
          {(isPlus || isFamily) && (
            <div className="space-y-2 text-xs text-gray-500">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-[#111111]">{isPlus ? 'MYR 7.99' : 'MYR 77.99'}</span>
              </div>
            </div>
          )}
        </div>
