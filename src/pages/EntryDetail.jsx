    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex items-center justify-between px-4 pt-12 pb-3 sticky top-0 bg-white z-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => setShowDeleteConfirm(true)} className="text-gray-400 hover:text-red-500">
      ...
      <div className="px-6 pb-12">
        ...
        <p className="text-sm text-gray-400 mb-2">
          {entryDate ? format(new Date(entryDate), 'EEEE, MMMM d, yyyy') : ''}
        </p>

        {/* Chapter tag */}
        {chapter && (
          <span className="inline-block text-xs bg-[#1A1A2E] text-white px-2.5 py-0.5 rounded-full font-medium mb-3">
            {chapter.name}
          </span>
        )}
        ...
        {/* Body */}
        <p className="text-base text-[#111111] leading-relaxed whitespace-pre-wrap mb-6">
          {entry.content}
        </p>
